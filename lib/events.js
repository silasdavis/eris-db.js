 ...
 */
Events.prototype.subscribe = function (event_id, callback) {
    this._client.methods.eventSubscribe({event_id}, callback)
};
 ...
 * @param {module:rpc/rpc~methodCallback} callback - The callback function.
 */
Events.prototype.unsubscribe = function (sub_id, callback) {
    this._client.methods.eventUnsubscribe({sub_id}, callback)
};
 ...
 */
Events.prototype.poll = function (sub_id, callback) {
    this._client.methods.eventPoll({sub_id}, callback)
};
