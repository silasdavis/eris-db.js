...
Events.prototype.subscribe = function(eventId, callback){
    this._backEnd.send(rpc.methodName("eventSubscribe"), rpc.eventIdParam(eventId), callback);
};
...
Events.prototype.unsubscribe = function(subId, callback){
    this._backEnd.send(rpc.methodName("eventUnsubscribe"), rpc.subIdParam(subId), callback);
};
...
Events.prototype.poll = function(subId, callback){
    this._backEnd.send(rpc.methodName("eventPoll"), rpc.subIdParam(subId), callback);
};
