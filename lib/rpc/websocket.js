...
var backEnd = require('./client');
var rpc = require('./rpc');
var WS;
if (typeof(window) !== "undefined"){
    WS = WebSocket;
} else {
    console.log("Not dist. Using 'ws' library.");
    WS = require('ws');
}
...
/**
 * The <tt>WebSocketClient</tt> class does RPCs over websockets.
 *
 * @param {string} URL - The endpoint URL.
...
function WebSocketClient(URL){
    backEnd.NetworkingBackEnd.call(this, URL);
    /**
