...
exports.getTests = function (edb, testData) {
  ...
  tests.push(['GetAccount', function (address, callback) {
    accounts.getAccount(address, function (error, response) {
      callback(error, R.omit('setPermission', response))
    })
  }, testData.GetAccount.input.address])
